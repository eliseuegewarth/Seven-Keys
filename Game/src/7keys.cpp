...
SevenKeys::load_level(const string& screen_type) {
    ...
    {
        string path_tecnologias = Internacionalization::load_string("images/tecnologias.png");
        level_to_be_loaded = (Level*) new FrontEnd("tecnologias", "classificacao", path_tecnologias);
    }
    else if (screen_type == "classificacao")
    {
        cout << "deu ruim" <<endl;
        string path_classificacao = Internacionalization::load_string("images/classificacao_indicativa.png");
    ...
    else if(strstr(screen_type.c_str(), "death"))
    {
        ...
        string path_transition = Internacionalization::load_string("images/transition.png");
    ...
    else if(screen_type == "gameover")
    {
        ...
        assert(lvl != NULL && "failed to create a Level instance");
        lvl->set_dimensions(width, height);
        string path_transition_game_over = Internacionalization::load_string("interface/transicao/gameOver.png");
